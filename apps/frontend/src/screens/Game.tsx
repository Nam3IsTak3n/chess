  ...
  useEffect(() => {
    ...
    socket.onmessage = (event) => {
      ...
      switch (message.type) {
        ...
        default:
          console.warn('Unknown message:', message.payload.message);
          break;
      }
    };
      ...
      <div className="justify-center flex">
        <div className="pt-2 w-full">
          <div className="flex gap-8 w-full">
            ...
            <div className="rounded-md pt-2 bg-bgAuxiliary3 flex-1 overflow-auto h-[95vh] no-scrollbar">
              {!started ? (
